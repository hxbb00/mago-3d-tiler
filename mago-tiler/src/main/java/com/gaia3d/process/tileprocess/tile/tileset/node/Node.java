...
public class Node {
    ...
    private void createOctTreeChildren() {
        ...
        child0.setBoundingVolume(new BoundingVolume(child0BoundingBox, BoundingVolume.BoundingVolumeType.REGION));
        ...
        child1.setBoundingVolume(new BoundingVolume(child1BoundingBox, BoundingVolume.BoundingVolumeType.REGION));
        ...
        child2.setBoundingVolume(new BoundingVolume(child2BoundingBox, BoundingVolume.BoundingVolumeType.REGION));
        ...
        child3.setBoundingVolume(new BoundingVolume(child3BoundingBox, BoundingVolume.BoundingVolumeType.REGION));
        ...
        child4.setBoundingVolume(new BoundingVolume(child4BoundingBox, BoundingVolume.BoundingVolumeType.REGION));
        ...
        child5.setBoundingVolume(new BoundingVolume(child5BoundingBox, BoundingVolume.BoundingVolumeType.REGION));
        ...
        child6.setBoundingVolume(new BoundingVolume(child6BoundingBox, BoundingVolume.BoundingVolumeType.REGION));
        ...
        child7.setBoundingVolume(new BoundingVolume(child7BoundingBox, BoundingVolume.BoundingVolumeType.REGION));
