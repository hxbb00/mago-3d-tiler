...
import com.gaia3d.converter.gltf.extension.ExtensionMeshFeatures;
...
public class BatchedModelGltfWriter extends GltfWriter {
    ...
    public BatchedModelGltfWriter() {
        super();
    }

    public BatchedModelGltfWriter(GltfWriterOptions gltfOptions) {
        super(gltfOptions);
    }
